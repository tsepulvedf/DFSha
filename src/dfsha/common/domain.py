...
class Fault(Exception):
    def __init__(self, reason, code=None):
        ...
        self.code = code or {
            ...
            'LOCK_CONFLICT': grpc.StatusCode.ABORTED,
            'HANDLE_BUSY': grpc.StatusCode.ABORTED,
            'SPARSE_WRITE_UNSUPPORTED': grpc.StatusCode.INVALID_ARGUMENT,
            'OUTCOME_UNKNOWN': grpc.StatusCode.DEADLINE_EXCEEDED,
