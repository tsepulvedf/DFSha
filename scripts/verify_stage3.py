...
def main():
    ...
    commands = [
        ...
        [sys.executable, '-m', 'pytest', '-q', '--ignore-glob=tests/test_stage7*.py', '--ignore=tests/test_hito2.py', '--ignore=tests/test_stage5.py', '--ignore=tests/test_stage6.py', f'--junitxml={directory / "pytest.xml"}'],
